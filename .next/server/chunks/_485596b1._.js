...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addJobScheduler",()=>tU],12429);let tU={name:"addJobScheduler",content:`--[[
...
return {jobId .. "", delay}
`,keys:11};e.s(["addLog",()=>tZ],29456);let tZ={name:"addLog",content:`--[[
  Add job log
  Input:
    KEYS[1] job id key
    KEYS[2] job logs key
...
`,keys:2};e.s(["addParentJob",()=>tH],95007);let tH={name:"addParentJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:6};e.s(["addPrioritizedJob",()=>tX],75418);let tX={name:"addPrioritizedJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["addRepeatableJob",()=>tB],63190);let tB={name:"addRepeatableJob",content:`--[[
...
`,keys:2};e.s(["addStandardJob",()=>tQ],97379);let tQ={name:"addStandardJob",content:`--[[
...
return jobId .. "" -- convert to string
`,keys:9};e.s(["changeDelay",()=>t0],61759);let t0={name:"changeDelay",content:`--[[
...
if rcall("EXISTS", ARGV[4]) == 1 then
  ...
  return -1
end`,keys:4};e.s(["changePriority",()=>t1],18407);let t1={name:"changePriority",content:`--[[
  Change job priority
  Input:
    KEYS[1] 'wait',
    KEYS[2] 'paused'
...
`,keys:7};e.s(["cleanJobsInSet",()=>t2],38662);let t2={name:"cleanJobsInSet",content:`--[[
...
return result[1]
`,keys:3};e.s(["drain",()=>t3],20308);let t3={name:"drain",content:`--[[
...
`,keys:5};e.s(["extendLock",()=>t4],63161);let t4={name:"extendLock",content:`--[[
...
return 0
`,keys:2};e.s(["extendLocks",()=>t6],55194);let t6={name:"extendLocks",content:`--[[
...
return failedJobs
`,keys:1};e.s(["getCounts",()=>t5],15608);let t5={name:"getCounts",content:`--[[
...
return results
`,keys:1};e.s(["getCountsPerPriority",()=>t8],56069);let t8={name:"getCountsPerPriority",content:`--[[
  Get counts per provided states
    Input:
      KEYS[1] wait key
      KEYS[2] paused key
...
return results
`,keys:4};e.s(["getDependencyCounts",()=>t7],21467);let t7={name:"getDependencyCounts",content:`--[[
...
return results
`,keys:4};e.s(["getJobScheduler",()=>t9],92181);let t9={name:"getJobScheduler",content:`--[[
...
return {nil, nil}
`,keys:1};e.s(["getMetrics",()=>re],64765);let re={name:"getMetrics",content:`--[[
  Get metrics
  Input:
    KEYS[1] 'metrics' key
...
`,keys:2};e.s(["getRanges",()=>rt],54208);let rt={name:"getRanges",content:`--[[
...
return results
`,keys:1};e.s(["getRateLimitTtl",()=>rr],20059);let rr={name:"getRateLimitTtl",content:`--[[
  Get rate limit ttl
    Input:
      KEYS[1] 'limiter'
      KEYS[2] 'meta'
...
`,keys:2};e.s(["getState",()=>rn],58113);let rn={name:"getState",content:`--[[
  Get a job state
  Input: 
...
return "unknown"
`,keys:8};e.s(["getStateV2",()=>ra],77231);let ra={name:"getStateV2",content:`--[[
  Get a job state
  Input: 
    KEYS[1] 'completed' key,
    KEYS[2] 'failed' key
...
return "unknown"
`,keys:8};e.s(["isFinished",()=>ri],24599);let ri={name:"isFinished",content:`--[[
...
return 0
`,keys:3};e.s(["isJobInList",()=>ro],27958);let ro={name:"isJobInList",content:`--[[
...
`,keys:1};e.s(["isMaxed",()=>rs],44397);let rs={name:"isMaxed",content:`--[[
...
`,keys:2};e.s(["moveJobFromActiveToWait",()=>rl],93952);let rl={name:"moveJobFromActiveToWait",content:`--[[
...
`,keys:9};e.s(["moveJobsToWait",()=>rd],3171);let rd={name:"moveJobsToWait",content:`--[[
...
return 0
`,keys:8};e.s(["moveStalledJobsToWait",()=>ru],54095);let ru={name:"moveStalledJobsToWait",content:`--[[
...
return stalled
`,keys:8};e.s(["moveToActive",()=>rc],38500);let rc={name:"moveToActive",content:`--[[
...
return {0, 0, 0, 0}
`,keys:11};e.s(["moveToDelayed",()=>rp],80219);let rp={name:"moveToDelayed",content:`--[[
...
`,keys:8};e.s(["moveToFinished",()=>ry],70379);let ry={name:"moveToFinished",content:`--[[
...
`,keys:14};e.s(["moveToWaitingChildren",()=>rh],88850);let rh={name:"moveToWaitingChildren",content:`--[[
...
return -1
`,keys:7};e.s(["obliterate",()=>rm],48946);let rm={name:"obliterate",content:`--[[
...
`,keys:2};e.s(["paginate",()=>rf],80299);let rf={name:"paginate",content:`--[[
...
`,keys:1};e.s(["pause",()=>rb],50679);let rb={name:"pause",content:`--[[
...
`,keys:7};e.s(["promote",()=>rK],67353);let rK={name:"promote",content:`--[[
...
`,keys:9};e.s(["releaseLock",()=>rg],68879);let rg={name:"releaseLock",content:`--[[
  Release lock
    Input:
      KEYS[1] 'lock',
      ARGV[1]  token
...
`,keys:1};e.s(["removeChildDependency",()=>rv],67432);let rv={name:"removeChildDependency",content:`--[[
...
if removeParentDependencyKey(jobKey, false, parentKey, KEYS[1], nil) then
  ...
  return 1
end`,keys:1};e.s(["removeJob",()=>rI],61929);let rI={name:"removeJob",content:`--[[
...
return 0
`,keys:2};e.s(["removeJobScheduler",()=>rE],50913);let rE={name:"removeJobScheduler",content:`--[[
...
return 1
`,keys:3};e.s(["removeRepeatable",()=>rS],31351);let rS={name:"removeRepeatable",content:`--[[
...
return 1
`,keys:3};e.s(["removeUnprocessedChildren",()=>rk],42664);let rk={name:"removeUnprocessedChildren",content:`--[[
    Remove a job from all the statuses it may be in as well as all its data.
    In order to be able to remove a job, it cannot be active.
    Input:
      KEYS[1] jobKey
...
removeJobChildren(prefix, jobKey, options) 
`,keys:2};e.s(["reprocessJob",()=>rj],2927);let rj={name:"reprocessJob",content:`--[[
...
`,keys:8};e.s(["retryJob",()=>rx],73683);let rx={name:"retryJob",content:`--[[
...
`,keys:11};e.s(["saveStacktrace",()=>rw],60148);let rw={name:"saveStacktrace",content:`--[[
...
`,keys:1};e.s(["updateData",()=>rD],5231);let rD={name:"updateData",content:`--[[
  Update job data
  Input:
    KEYS[1] Job id key
    ARGV[1] data
...
`,keys:1};e.s(["updateJobScheduler",()=>rT],85029);let rT={name:"updateJobScheduler",content:`--[[
...
`,keys:12};e.s(["updateProgress",()=>rA],51296);let rA={name:"updateProgress",content:`--[[
  Update job progress
  Input:
    KEYS[1] Job id key
...
`,keys:3};e.s(["updateRepeatableJobMillis",()=>rR],15409);let rR={name:"updateRepeatableJobMillis",content:`--[[
  Adds a repeatable job
    Input:
      KEYS[1] 'repeat' key
      ARGV[1] next milliseconds
