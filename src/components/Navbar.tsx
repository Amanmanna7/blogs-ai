...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/95 backdrop-blur-md border-b border-blue-100 shadow-sm sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16">
            ...
            <Link 
              ...
              className={`relative px-4 py-2 rounded-lg transition-all duration-300 group ${
                isActive('/courses')
                  ...
                  : 'text-gray-700 font-medium hover:text-blue-700 hover:bg-white/60'
              }`}
            >
              <span className="relative z-10">Courses</span>
              <div className="absolute inset-0 bg-blue-100/70 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-sm"></div>
            </Link>
            ...
            {hasPermission('MANAGE_USERS') && (
              <Link 
                ...
                className={`relative px-4 py-2 rounded-lg transition-all duration-300 group ${
                  isActive('/admin')
                    ? 'text-blue-800 font-semibold'
                    : 'text-gray-700 font-medium hover:text-red-700 hover:bg-white/60'
                }`}
              >
          ...
          <div className="flex items-center space-x-3">
            ...
            <SignedOut>
              ...
              >
                <button className="relative bg-blue-600 text-white px-6 py-2.5 rounded-xl font-medium shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200/50 backdrop-blur-sm border border-white/20">
                  ...
                  <div className="absolute inset-0 bg-blue-700 rounded-xl opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
                </button>
              </SignInButton>
            </SignedOut>
                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white/95 backdrop-blur-md border border-blue-100/50 shadow-xl rounded-xl overflow-hidden z-50">
                    ...
                    <div className="py-2">
                      <Link
                        ...
                        className="flex items-center space-x-3 px-4 py-2.5 text-gray-700 hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 group"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
