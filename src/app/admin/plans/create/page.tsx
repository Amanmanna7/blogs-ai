                ...
                <ol className="flex items-center space-x-4">
                  ...
                  <li>
                    <div className="flex items-center">
                      ...
                      <span className="ml-4 text-sm font-medium text-gray-500">Create Plan</span>
                    </div>
                  </li>
                </ol>
              </nav>
              <h1 className="text-3xl font-bold text-gray-900 mt-4">Create New Plan</h1>
              <p className="mt-2 text-gray-600">Fill in the details to create a new subscription plan</p>
            </div>
            <Link
              href="/admin/plans"
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <p className="text-sm text-gray-600 mb-6">Add features that are included in this plan</p>
            ...
            {features.length === 0 ? (
              ...
              <div className="space-y-3">
                <h4 className="text-md font-medium text-gray-900">Added Features ({features.length})</h4>
