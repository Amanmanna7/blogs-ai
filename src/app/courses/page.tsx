...
export default function CoursesPage() {
  ...
  }, [courses, searchTerm, selectedSubjectType, sortOrder]);
        ...
        <div className="relative container mx-auto px-4 py-20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm text-blue-200">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>AI-Powered Doubt Resolution</span>
            </div>
            <div className="flex items-center space-x-2">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span>Free Content + Premium AI</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="mx-auto max-w-6xl">
                <div className="mb-8 text-center">
                  ...
                  <p className="text-lg text-gray-600">
                    Start your learning journey with our carefully curated course collection
                  </p>
                </div>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none rounded-lg border border-gray-300 bg-white py-3 pl-4 pr-12 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-200"
                      >
